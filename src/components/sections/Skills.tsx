...
const RenderIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    <path d="M4.18 20.25H2.43V3.75h5.4c1.32 0 2.4.21 3.24.63.84.42 1.48 1.05 1.92 1.89.44.84.66 1.88.66 3.12 0 1.25-.21 2.29-.63 3.12-.42.83-1.05 1.46-1.89 1.89-.84.43-1.89.65-3.15.65H4.18v5.2zm0-7.8h3.65c.82 0 1.5-.14 2.04-.42.54-.28.95-.69 1.23-1.23.28-.54.42-1.21.42-2.01s-.14-1.47-.42-2.01c-.28-.54-.69-.95-1.23-1.23-.54-.28-1.22-.42-2.04-.42H4.18v7.32zm9.14 7.8l4.41-7.8h2.09l-4.41 7.8H13.32z" />
  </svg>
);
