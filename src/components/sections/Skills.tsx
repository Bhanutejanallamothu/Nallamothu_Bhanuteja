...
const RenderIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    <path d="M21.1 11.2c0-3.1-2.5-5.6-5.6-5.6-2.1 0-3.9 1.2-4.8 2.9-.5-.1-1-.2-1.5-.2-2.3 0-4.3 1.5-5.1 3.5-.1 0-.1 0-.2 0-2.1 0-3.9 1.7-3.9 3.9v8.3h10v-5.6c0-1.1.9-2 2-2h3.5v7.6h5.6v-12.8z"/>
  </svg>
);
